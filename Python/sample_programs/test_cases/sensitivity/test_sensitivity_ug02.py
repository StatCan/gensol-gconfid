...
def sensitiv_expected_outcell():
    return gconfid.testing.PAT_from_string("""
    n n n n n n s s n n n s s 
    CellId	NbAnonym	AnonymTotalVar	NbRespondents	TotalVar	Sensitivity	Status	Type	TotalNoise	SensitivityBeforeWaivers	FavCost	reg	cla
    1	0	0	2	250	18	S	C	250	32	250	R1	C1
    2	0	0	3	350	-116	V	C	350	22	940	R1	C2
    3	0	0	3	340	-8	V	C	340	10	940	R1	C3
    4	0	0	1	120	0	V	C	120	24	420	R2	C1
    5	0	0	3	220	-32	V	C	220	-32	220	R2	C2
    6	0	0	3	80	-2	V	C	80	-2	80	R2	C3
    7	0	0	12	1360	-714	V	C	1360	-686	1360	Tot_Reg	Tot_Cla
    8	0	0	6	940	-294	V	C	940	-266	940	R1	Tot_Cla
    9	0	0	6	420	-156	V	C	420	-156	420	R2	Tot_Cla
    10	0	0	3	370	-102	V	C	370	-58	370	Tot_Reg	C1
    11	0	0	6	570	-252	V	C	570	-198	570	Tot_Reg	C2
    12	0	0	6	420	-88	V	C	420	-70	420	Tot_Reg	C3
    """)
