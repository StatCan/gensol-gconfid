# Contributor Covenant Code of Conduct for the `gconfid` project

([Français](#code-de-conduite-pour-le-projet-gconfid))

Contributors to repositories hosted in `gconfid` are expected to follow the Contributor Covenant Code of Conduct, and those working within Government are also expected to follow the Values and Ethics Code for the Public Sector
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by contacting the project team at [statcan.gconfid-gconfid.statcan@statcan.gc.ca](mailto:statcan.gconfid-gconfid.statcan@statcan.gc.ca).
...
# Code de conduite pour le projet `gconfid`
<!--markdownlint-enable MD025-->

([English](#contributor-covenant-code-of-conduct-for-the-project_gconfid))

Les contributeurs aux dépôts hébergés dans `gconfid` sont tenus de respecter le Code de conduite du Pacte des contributeurs, et ceux qui travaillent au sein du gouvernement sont également tenus de respecter le Code de valeurs et d'éthique du secteur public.
...
Les cas de comportement abusif, de harcèlement ou d'autres comportements inacceptables peuvent être rapportés en communiquant avec l'équipe de projet à l'adresse suivante :[statcan.gconfid-gconfid.statcan@statcan.gc.ca](mailto:statcan.gconfid-gconfid.statcan@statcan.gc.ca).
